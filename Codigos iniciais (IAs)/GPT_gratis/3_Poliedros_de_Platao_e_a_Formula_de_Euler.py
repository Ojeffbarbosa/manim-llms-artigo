from manim import *
from manim.objects.polyhedron import Polyhedron

class PoliedrosEuler(ThreeDScene):
    def construct(self):
        poliedros = [
            ("Tetraedro", Polyhedron.Tetrahedron(), 4, 6, 4),
            ("Cubo", Polyhedron.Cube(), 8, 12, 6),
            ("Octaedro", Polyhedron.Octahedron(), 6, 12, 8),
            ("Dodecaedro", Polyhedron.Dodecahedron(), 20, 30, 12),
            ("Icosaedro", Polyhedron.Icosahedron(), 12, 30, 20),
        ]
